...
// function to get the nth row of the pascals triangle
vector<int> getRow(vector< vector<int> > v, int rowIndex)
{
    return v[rowIndex-1];
}
...
//function to print the row from the pascals triangle
void printRow(vector<int> mrr)
{
    cout << "The final row of the Pascal's Triangle: " << endl;
...
int main()
{
    ...
    //calling to generate the nth row of the pascasl triangle
    vector<int> mrr = getRow(v, n);

    //function to print that row
    printRow(mrr);
